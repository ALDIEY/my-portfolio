  ...
  return (
    ...
    >
      <div className="max-w-3xl">
        <div className="rounded-lg border border-base-line bg-base-raised/60 font-mono text-sm p-6 mb-10 shadow-2xl">
        ...
        <p className="font-display text-xl sm:text-2xl text-gold mt-3">
        ...
        <div className="flex flex-wrap gap-3 mt-8">
          <a
            href="#release"
            className="px-5 py-2.5 rounded-md bg-gold text-base font-medium hover:bg-gold-dim transition-colors"
          >
            Demander un déploiement
          </a>
          <a
            href="#test"
            className="px-5 py-2.5 rounded-md border border-base-line text-ink hover:border-teal-bright transition-colors"
          >
            Voir les projets
          </a>
        </div>
