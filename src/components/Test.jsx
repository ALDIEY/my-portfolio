...
import { IconTerminalCheck } from "./icons";
import Reveal from "./Reveal";

export default function Test() {
  return (
    <section id="test" className="px-8 lg:px-32 py-28 border-t border-base-line">
      <SectionHeader stage="02 / TEST" title="Projets" icon={IconTerminalCheck} />

      <div className="mt-12 space-y-4">
        {PROJECTS.map((project, i) => (
          <Reveal key={project.id} delay={i * 80}>
            <div className="rounded-lg border border-base-line bg-base-raised/40 p-6 flex flex-col sm:flex-row sm:items-start gap-4 transition-all duration-300 hover:border-teal-bright/50 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/20">
